<template>
  <div class="link">
    ...
    <div class="svg_block">
      <a :href="item.url" v-for="item in linkList" :key="item.title">
        <svg
          viewBox="0 0 300 100"
        ...
        <div class="top">
          ...
          />
          <span :class="!item.logo && 'svg_span'">{{ item.title }}</span>
        </div>
