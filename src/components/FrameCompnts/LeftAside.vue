  ...
  <div :class="{ fixed: ifFixed, left_side: true }">
    <div class="personal_info">
        ...
        <ul>
          ...
          <li>
            <a-popover placement="bottom" trigger="click">
              <template #content>
                <img
                  src="../../assets/img/infoSelf/wechat.jpg"
                  alt=""
                  width="100px"
                  height="100px"
                />
      ...
      <div class="bottom_btn">
        <a href="https://github.com/Nerissa-321/share" target="_blank">
        ...
        <template #renderItem="{ item }">
          <a-list-item>
            <a-card :title="item.name">
              <a-image width="100%" height="100%" :src="item.avatar" />
              <!-- <img
                :src="item.avatar"
...
const socialList = reactive([
  {
    ...
    name: "GitHub",
    qrCode: "",
    url: "https://github.com/Nerissa-321",
    title: "",
  },
  {
    icon: "&#xe8db;",
